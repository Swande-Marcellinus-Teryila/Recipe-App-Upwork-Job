                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($ingredients as $ingredient)
                                                            ...
                                                            <tr>
                                                             ...
                                                             {{ $ingredient->small_unit->measurement}}
                                                            </td>
                                        ...
                                        </div><a href="#" class="btn btn-primary"> NEXT</a>
                                    </div>
                                </div> 
                            </div>
                    </section>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-12">
                                            <label for="inputText" class="col-sm-5 col-form-label text text-danger">Please select package measurement</label>
                                            <div class="col-sm-12">
                                                <select name="measurement_id" class="form-control" id="major_units" onchange="getSmallUnit(this.value)" required>
                                                    <option value=""></option>
                                        ...
                                        <div id="section2">
                                        <div class="row mb-12">
                                            <label for="inputText" class="col-sm-5 col-form-label">Package Cost</label>
                                            <div class="col-sm-12">
                                                <input type="number" step="0.2" class="form-control" name="cost" id="cost"
                                                    required>
                                            </div>
                                        </div>

                                        <div class="row mb-12">
                                            <label for="inputText" class="col-sm-5 col-form-label">Package Size</label>
                                            <div class="col-sm-12">
                                                <input type="number"  class="form-control" name="package_size" id="package_size"
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-12">
                                            ...
                                            <div class="col-sm-12" id="small_units">
                                                
                                            </div>
                                        </div>
                                        

                                        Ingredient price: <div class="" id="ingredient_price">
                                           
                                        </div>
                                        <input type="hidden" name="serving_cost" id="serving_cost" />
                                        </div>
